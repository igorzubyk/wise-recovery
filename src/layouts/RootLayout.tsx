  ...
  return (
    <Website>
      <Helmet>
        ...
        <meta name="description" content="Wise Recovery offers psychiatrist-led group programming for people living with serious mental illness and their families. Created by Monica Slubicki, MD." />
      </Helmet>
